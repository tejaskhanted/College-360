...
<body>
    ...
    Offered by DoMS IIT Madras - Department of Management Studies
                                    ...
                                    <a href="course%20detail.php?varname=2" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    Offered by IIT Madras - Department of Computer Engineering
                                     ...
                                     <div style="text-align:center">
                                    <a href="course%20detail.php?varname=3" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by IIT Madras - Department of Mechanical Engineering
                                    ...
                                    <div style="text-align:center">
                                    <a href="course%20detail.php?varname=4" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by DoMS IIT Madras - Department of Electrical Studies
                                   ...
                                   <div style="text-align:center">
                                    <a href="course%20detail.php?varname=1" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by IIT Madras - Department of Chemical Engineering
                                    ...
                                    <div style="text-align:center">
                                    <a href="course%20detail.php?varname=5" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by IIT Madras - Department of Civil Engineering
                                   ...
                                   <div style="text-align:center">
                                    <a href="course%20detail.php?varname=6" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
