...
<body>
    ...
    Offered by All India Institute of Medical Sciences,Delhi
                                    ...
                                    <a href="course%20detail.php?varname=7" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    Offered by Maulana Azad Medical <br> College
                                     ...
                                     <div style="text-align:center">
                                    <a href="course%20detail.php?varname=8" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by Christian Medical College (CMC), Vellore
                                    ...
                                    <div style="text-align:center">
                                    <a href="course%20detail.php?varname=9" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by Loyola College,<br> Chennai
                                   ...
                                   <div style="text-align:center">
                                    <a href="course%20detail.php?varname=10" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by Christian Medical College,Vellore
                                    ...
                                    <div style="text-align:center">
                                    <a href="course%20detail.php?varname=11" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Offered by Armed Forces Medical College,Pune
                                   ...
                                   <div style="text-align:center">
                                    <a href="course%20detail.php?varname=12" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  for($i=$cfg_min_stars; $i<=$cfg_max_stars; $i++) { 
    ...
    ?>
                      ...
                      <div style="text-align:right">
                          <a href="review.php?varname=<?php echo $result2['id']; ?>" class="btn btn-primary" >Read More</a></div>
