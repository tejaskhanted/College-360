...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class=" active" href="home2.php" style="font-size: 17px;"><b>Home</b> </a>
                    </li>
                    <li class="nav-item">
   ...
   <div class="header">
        <form  autocomplete="off" action="searchcollegeinfo2.php" style="max-height: 100%; max-width: 90%;">
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                  ...
                                  <div style="text-align:center">
                                    <a href="collegeinfo2.php?varname=<?php echo 1 ?>" class="btn btn-primary">View college</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                    <a href="collegeinfo2.php?varname=<?php echo 2 ?>" 
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 3 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 4 ?>"  class="btn btn-primary" >View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 5 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 7 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 8 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 6 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfo2.php?varname=<?php echo 9 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                  ...
                                  <div style="text-align:center">
                                    <a href="collegeinfom2.php?varname=<?php echo 10 ?>" class="btn btn-primary">View college</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                    <a href="collegeinfom2.php?varname=<?php echo 11 ?>" 
                                       class="btn btn-primary" >View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 12 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 13 ?>"  class="btn btn-primary" >View college</a></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp;Lucknow,Uttar Pradesh<br/> Rating : 4.7 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star-half-o" aria-hidden="true" style="color: #e5bc36"></i>
                                    </p>
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 14 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 15 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 16 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
...
" alt="Card image cap" width="250px" height="225px">
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 17 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center">
                                        <a href="collegeinfom2.php?varname=<?php echo 18 ?>"  class="btn btn-primary">View college</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
     ...
     <div class="container-fluid" id="r1">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="bottom">
            ...
            <div class="f1" style="text-align: center;">
                <form method="post" data-toggle="validator" role="form" id="form" action="home2.php">
