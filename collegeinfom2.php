...
$sql = "SELECT `id`, `clgimage`, `clgname`, `type`, `year`, `institute`, `location`, `rating`, `img1`, `img2`, `img3`, `img4`, `img5`, `img6`, `img7`, `img8` FROM `collegeinfo` WHERE id=$var_value";
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bachelor of Surgery <br>[MBBS] </h4>
                                    <p class="card-text">
                                        Rating : 4.5 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star-half-o" aria-hidden="true" style="color: #e5bc36"></i><br/> Fees : ₹ 1-10 Lakh<br/>Duration : 5.5 years | Full Time<br/>Exams: NEET, AIIMST<br/>
    Offered by All India Institute of Medical Sciences,Delhi
                                    </p>
                                    <div style="text-align:center">
                                    <a href="course%20detail2.php?varname=7" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bachelor of Dental <br> Surgery [BDS]</h4>
                                    <p class="card-text">
                                        Rating : 4.6 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star-half-o" aria-hidden="true" style="color: #e5bc36"></i><br/> Fees : ₹ 5 Lakh<br/>Duration : 4 years | Full Time<br/>Exams: NEET, MU OET, DUMET<br/>
    Offered by Maulana Azad Medical <br> College
                                    </p>
                                     <div style="text-align:center">
                                    <a href="course%20detail2.php?varname=8" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bachelor of Physiotherapy [BPT]</h4>
                                    <p class="card-text">
                                        Rating : 4.7 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star-half-o" aria-hidden="true" style="color: #e5bc36"></i><br/> Fees : ₹ 1-5  Lakh<br/>Duration : 4 years | Full Time<br/>Exams: CET, JIPMER<br/>
Offered by Christian Medical College (CMC), Vellore
                                    </p>
                                    <div style="text-align:center">
                                    <a href="course%20detail2.php?varname=9" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bachelor of Science [B.Sc] (Biotechnology)</h4>
                                    <p class="card-text">
                                        Rating : 4.9 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><br/> Fees : ₹ 1-3 Lakh<br/>Duration : 3 years | Full Time<br/>Exams: AIIMS,JNU<br/>
Offered by Loyola College,<br> Chennai
                                    </p>
                                   <div style="text-align:center">
                                    <a href="course%20detail2.php?varname=10" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bachelor of Science [B.Sc] (Cardiac Technology)</h4>
                                    <p class="card-text">
                                        Rating : 4.7 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><br/> Fees : ₹ 1-4 Lakh<br/>Duration : 3 years | Full Time<br/>Exams: JIPMER <br/>

Offered by Christian Medical College,Vellore
                                    </p>
                                    <div style="text-align:center">
                                    <a href="course%20detail2.php?varname=11" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Doctorate of Medicine [MD] (Pathology)</h4>
                                    <p class="card-text">
                                        Rating : 4.6 &nbsp;<i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><i class="fa fa-star" aria-hidden="true" style="color: #e5bc36"></i><br/> Fees : ₹ 2-25 Lakh<br/>Duration : 3 years | Full Time
                                        <br/>Exams: PG-NEET<br/>

Offered by Armed Forces Medical College,Pune
                                    </p>
                                   <div style="text-align:center">
                                    <a href="course%20detail2.php?varname=12" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
       ...
       <div class="container-fluid" id="r1">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="bottom">
            ...
            <div class="f1" style="text-align: center;">
                <form method="post" data-toggle="validator" role="form" id="form" action="collegeinfo2.php?varname=<?php echo $var_value ?>">
